  ...
  return (
    ...
    >
        <motion.div
          ...
          className="glass p-8 rounded-2xl max-w-md w-full mx-4 border-2 border-[#00C896]/30"
        ...
        >
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold mb-2 text-gray-900">Enter PIN</h2>
            ...
            <div className="flex justify-center gap-2">
              {pin.map((digit, index) => (
                <Input
                  ...
                  onPaste={handlePaste}
                  className="w-12 h-14 text-center text-2xl font-bold border-2 border-gray-300 focus:border-[#00C896] focus:ring-[#00C896]"
