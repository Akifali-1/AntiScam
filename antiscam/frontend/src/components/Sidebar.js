      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 top-0 h-full w-80 glass z-50 shadow-2xl border-r border-indigo-200"
            data-testid="sidebar"
          >
            <div className="flex flex-col h-full">
              <div className="flex items-center justify-between p-6 border-b border-indigo-200/50 bg-gradient-to-r from-indigo-50/50 to-blue-50/50">
